...
public class Vendas {
	...
	//Retorna o número de cadeiras disponíveis; Implementado por Iago Rodrigues
	public int teatroDisponivel() {
		int disponiveis;
		
		disponiveis = teatro.tamanhoTeatro() - teatro.getOcupados();
